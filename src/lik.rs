...
fn log_intergral_exact(k: f64, segment_start: f64, segment_end: f64, n: f64, mu: f64) -> f64 {
...
fn log_integral_exact_inf(k: f64, segment_start: f64, n: f64, mu: f64) -> f64 {
    if segment_start == 0.0 {
...
fn log_neg_antiderivative(k: f64, t: f64, segment_start: f64, n: f64, mu: f64) -> f64 {
